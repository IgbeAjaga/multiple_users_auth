...
<div class="card mt-5">
  ...
  <div class="card-body">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a class="btn btn-primary btn-sm" href="{{ route('outgoingcalls.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {{ $outgoingcalls->branchthatcalled }}
            </div>
        </div>
    </div>
